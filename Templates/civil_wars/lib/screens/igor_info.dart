...
class IgorInfo extends StatelessWidget {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "Igor deals with potent medicaments, but never call him a snake oil salesman! He shoots a long range dart that can hit both opponents and friendlies. Opponents will take damage over time and friendlies will heal over time.",
                        style: TextStyle(
                          fontFamily: "Lilita One",
                          color: kDarkBlue,
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  width: kProgressBarWidth,
                                  child: LinearProgressIndicator(
                                    value: 150.toDouble() / kMaxDefence,
                                    color: kRed,
                                  ),
                                ),
                              ),
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  width: kProgressBarWidth,
                                  child: LinearProgressIndicator(
                                    value: 2000.toDouble() / kMaxHealth,
                                    color: kRed,
                                  ),
                                ),
                              ),
